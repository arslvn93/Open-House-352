const config = {
  "property": {
    "streetAddress": "1361 Zealand Road ",
    "city": "Frontenac",
    "cityStateZip": "Frontenac, Ontario  K0H 2P0",
    "heroSubtitle": "Discover a home that goes beyond mere living – a 4-bedroom Detached that stands as a beacon of modern architectural brilliance. Spread across an impressive 1980 sq ft and featuring 2 meticulously designed bathrooms, this property represents the perfect intersection of form and function. Each element has been carefully considered to create a living space that is not just a house, but a true reflection of contemporary lifestyle and sophisticated design principles.",
    "backgroundImageUrl": "https://salesgenius.s3.ca-central-1.amazonaws.com/uploads/1762275132012-DSC_7683-Edit.jpg"
  },
  "realtor": {
  ...
  "meta": {
    "pageTitlePrefix": "🏡 Ashley Armstrong Open House",
